...
public class EditStage extends Stage {
  public EditStage(int codeId, int dataId, double value1, double value2, List<String> skillList, List<String> stateList, List<String> commonEventList) {
    try {
      ...
      controller.setInitialValues(codeId, dataId, value1, value2, skillList, stateList, commonEventList);
